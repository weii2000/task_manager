    ...
    project = await create_project_by_data(
        {
            ...
            "start_time": _to_database_time(planned_project.start_time),
            "due_time": _to_database_time(planned_project.due_time),
            ...
            task = await create_task_by_data(
                {
                    ...
                    "creation_source": CreationSource.AGENT,
                    "start_time": _to_database_time(
                        planned_task.start_time
                    ),
                    "due_time": _to_database_time(planned_task.due_time),
                },
                context.db,
            )
